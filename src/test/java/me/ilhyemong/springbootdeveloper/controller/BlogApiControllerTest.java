...
import me.ilhyemong.springbootdeveloper.dto.UpdateArticleRequest;
...
class BlogApiControllerTest {
    ...
    public void updateArticle() throws Exception {
        // given
        final String url = "/api/articles/{id}";
        final String title = "첫번째 글";
        final String content = "본문 내용입니다.";
        ...
        final String newTitle = "수정된 글";
        final String newContent = "수정된 내용입니다.";
